...
{  
	...
	try 
	{
	   ...
	   String str=R1.TakeScreenShotAuto(driver,"Nationality Page - Nationality Entered","Pass");
	   ...
	   // str=R1.getScreenShotPath(driver);
	    str=R1.TakeScreenShotAuto(driver,"Nationality Page - Scroll and verify the record details","Pass");
